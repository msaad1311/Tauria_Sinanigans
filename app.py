...
car_generator = Generator().to(device).load_state_dict(torch.load(checkpoint_car))

seg_model = MODNet(backbone_pretrained=False)
seg_model = nn.DataParallel(seg_model)
seg_model = seg_model.to(device).load_state_dict(torch.load(checkpoint_seg))
